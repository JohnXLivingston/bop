...
declare global {
  interface JQuery {
    ...
    findBopWidget: (this: JQuery, name?: string) => JQuery
  }
...
const findBopWidget = function (this: JQuery, name?: string): JQuery {
  return this.find(makeAttributeSelector('data-widget', name))
}
