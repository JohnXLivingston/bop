...
planningRouter.get('', i18nChangeLocale, authenticatedOrLogin, (req, res) => {
  ...
  nodes.push({
    name: 'Resource 1',
    data: [
      { left: 0, width: 90, label: '10 h/j', color: 'red', type: 'summary' },
      { left: 135, width: 45, label: '8 h/j', color: 'green', type: 'summary' }
    ],
    childs: [
      {
        ...
        data: [
          { left: 45, width: 180, label: '8h/j', color: '#79c5ee', type: 'task' },
          { left: 360, width: 45, label: '8h/j', color: '#79c5ee', type: 'task' }
        ]
      }
    ]
  })
