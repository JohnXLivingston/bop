...
import { ProjectCrud } from '../../src/crud/project/project'
...
describe('crud/project/project.ts', function () {
  ...
  dbTest.testCrudCreationAndDeletion<ProjectCrud>({
    name: 'Project',
    ObjectClass: ProjectCrud,
    data: project1Data,
